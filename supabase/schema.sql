-- GSMA Ghana Official Website Database Schema
-- This file contains all the database tables needed for the admin panel
...
-- Note: Admin user should be created using the create-admin-user.js script
-- The script will generate a proper bcrypt hash for the password
-- Example: node scripts/create-admin-user.js admin@gsma.gov.gh yourpassword "Admin Name"

-- Insert default site settings
INSERT INTO site_settings (key, value, type) VALUES
    ('site_name', 'GSMA Ghana', 'text'),
    ('site_description', 'Official website of the  Ga South Municipal Assembly', 'textarea'),
